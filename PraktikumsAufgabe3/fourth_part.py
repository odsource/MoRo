from PraktikumsAufgabe3 import ParticleFilterPoseEstimator
from PraktikumsAufgabe3 import first_part
from PraktikumsAufgabe3 import second_part
import numpy as np
...
if __name__ == "__main__":
    ...
    grid = second_part.generateDistanceGrid(myWorld)
    myRobot = Robot.Robot()
    ...
    poses = first_part.MCcurveDrive(myRobot, v, r, theta, n)
